...
- **不要為了餵這個工具去批次抓病歷。** 醫療法第 72 條規定因業務知悉的病情與健康
  ...
  醫院另有醫院個人資料檔案安全維護計畫實施辦法：須與所屬人員約定個資儲存媒介的
  保管與保密義務（第 11 條第 3 款），人員離職時持有的文件資料須辦理交接、不得攜離
  使用（第 11 條第 4 款），個資使用紀錄與軌跡至少留存六個月（第 15 條）。超出
  照護關係取得紀錄可能觸及刑法第 359 條。同樣的按鍵、不同的範圍：照護自己的病人是有授權的，
